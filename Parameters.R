...
URL_MIV_2022<-"https://data.stadt-zuerich.ch/dataset/sid_dav_verkehrszaehlung_miv_od2031/download/sid_dav_verkehrszaehlung_miv_OD2031_2022.csv"
...
PATH_MIV_2022 <- here::here("data", "miv", "sid_dav_verkehrszaehlung_miv_od2031_2022.csv")
...
PATH_COUNTING_DATA_2022 <- "https://data.stadt-zuerich.ch/dataset/ted_taz_verkehrszaehlungen_werte_fussgaenger_velo/download/2022_verkehrszaehlungen_werte_fussgaenger_velo.csv"
